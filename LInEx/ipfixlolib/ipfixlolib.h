 ...
 */
typedef struct ipfix_exporter_t {
	...
	int (*compression_function)(struct ipfix_exporter_t *);
	// Buffer which is used to store the compressed data
	unsigned char compression_buffer[IPFIX_MAX_PACKETSIZE];
#endif
} ipfix_exporter;
